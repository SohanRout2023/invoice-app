...
const NewInvoice = () => {
    ...
    const navigation = useNavigate()     // redirects new invoice to invoices of firebase data base 
    const addProduct = () => {
    ...
    const saveData = async () =>{
        ...
        console.log(product)
        console.log(total)
        const data = await addDoc(collection(db,'invoices'),{     // to store it in data base
            to:to,
            phone:phone,
            address:address,
            product:product,
        ...
        console.log(data)
        navigation('/dashboard/invoices')     // regirects New Invoice to invoices
    }
    return (
        <div>
                <div className='header-row'>
                <p className='new-invoice-heading'>NewInvoice</p>
